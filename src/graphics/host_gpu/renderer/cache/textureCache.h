...
private:
	...
	void                                 EraseImageSlot(ImageId id);
	[[nodiscard]] ImageId                SwapDepthAlias(const ImageInfo& requested, ImageId cached_id);
	void                                 ProbeImageDelete(const char* reason, ImageId id);
